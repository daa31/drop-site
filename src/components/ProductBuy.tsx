    ...
    <div className="mt-8">
      ...
      <div className="mt-5 flex gap-3">
        <button
          ...
          className="inline-flex h-12 flex-1 items-center justify-center gap-2 rounded-full bg-ink px-4 text-sm font-semibold text-white transition hover:bg-black disabled:cursor-not-allowed disabled:bg-graphite/35 sm:px-7 lg:flex-none"
        >
          <ShoppingBag size={17} />
          {t("add")}
          <span className="lg:hidden"> - {formatPrice(total, locale)}</span>
        </button>
        <button
          type="button"
          onClick={(event) => {
